...
export const metadata: Metadata = {
  title: "Trending Movies and TV Shows | MovieFlix",
  description: "Browse what's trending in movies and TV shows right now on MovieFlix.",
  openGraph: {
    title: "Trending Movies and TV Shows | MovieFlix",
    description: "Browse what's trending in movies and TV shows right now on MovieFlix.",
    url: "https://movieflix.vercel.app/trending",
    siteName: "MovieFlix",
    type: "website",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://movieflix.vercel.app/trending",
  },
}
