...
export default function TvStructuredData({ tvShow }: { tvShow: TvDetails }) {
  ...
  const structuredData = {
    ...
    url: `https://moviewoods.vercel.app/tv/${tvShow.id}`,
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `https://moviewoods.vercel.app/tv/${tvShow.id}`,
      },
    },
    season: tvShow.seasons.map((season) => ({
      ...
      url: `https://moviewoods.vercel.app/tv/${tvShow.id}/season/${season.season_number}`,
