...
export default function EpisodeStructuredData({ tvShow, season, episode, params }: EpisodeStructuredDataProps) {
  const structuredData = {
    ...
    url: `https://moviewoods.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
    partOfSeries: {
      "@type": "TVSeries",
      name: tvShow.name,
      url: `https://moviewoods.vercel.app/tv/${params.id}`,
    },
    partOfSeason: {
      "@type": "TVSeason",
      seasonNumber: Number.parseInt(params.seasonNumber),
      name: season.name,
      url: `https://moviewoods.vercel.app/tv/${params.id}/season/${params.seasonNumber}`,
    },
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `https://moviewoods.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
      },
    },
    video: {
      "@type": "VideoObject",
      ...
      contentUrl: `https://moviewoods.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
    },
  }
